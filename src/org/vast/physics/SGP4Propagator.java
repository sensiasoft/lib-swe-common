...
public class SGP4Propagator
{
    ...
    public MechanicalState getECIOrbitalState(double time, TLEInfo tle)
    {
        ...
        double beta, coef, eeta, delm, delo, aodp, capu, xmdf, aynl,
            ...
            ao, qoms2t, /*dragcf,*/ pl, omgadf, rk, qo, uk, so, xl, xn, delomg,
            omgcof, perige, ux, uy, uz, vx, xnodcf, xnoddf, vy, vz, /*xmnpda,*/ xnodek,
            omgdot, rfdotk, e6a, cosnok, ck2, cosepw, ck4, /*rdprmn,*/ tothrd, sinepw,
        ...
        System.out.println(DateTimeFormat.formatIso(time, 0));
        double tsince = (time - tle.getTleTime()) / 60.0;
        System.out.println(tsince);
        ...
        a = aodp * (d__1 * d__1);
        e = eo - tempe;
        //rdprmn = xnodp * (float)1.5 * c1;

        //  RAD/MIN^2
        //dragcf = xnodp * (float)1.5 * c2;
